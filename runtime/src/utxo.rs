...
pub struct TransactionInput{
	...
	pub sigscript : H512, //proof of transaction owner
}
...
pub struct TransactionOutput{
	...
	pub pubkey : H256, //public key associated with this output. In order to spend this, the owner must provide a proof by hashing the whole 'Transaction' and signing it with a corresponding private key
}
